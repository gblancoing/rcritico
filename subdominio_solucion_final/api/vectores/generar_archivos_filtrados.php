<?php
// Script para generar archivos PHP filtrados para todas las tablas de vectores
// Este script crea archivos PHP que permiten filtrar por proyecto_id

$tablas = [
    'real_parcial' => 'Real Parcial',
    'real_acumulado' => 'Real Acumulado', 
    'v0_parcial' => 'V0 Parcial',
    'v0_acumulada' => 'V0 Acumulada',
    'npc_parcial' => 'NPC Parcial',
    'npc_acumulado' => 'NPC Acumulado',
    'api_parcial' => 'API Parcial',
    'api_acumulada' => 'API Acumulada'
];
...
echo "Generando archivos PHP filtrados para las tablas de vectores...\n\n";

foreach ($tablas as $tabla => $descripcion) {
    $filename = $tabla . '_filtrado.php';
    $content = str_replace('{TABLA}', $tabla, $template);
    
    if (file_put_contents($filename, $content)) {
        echo "✓ Generado: $filename ($descripcion)\n";
    } else {
...
echo "Estos archivos permiten filtrar por proyecto_id usando el parámetro GET.\n";
echo "Ejemplo de uso: /api/vectores/real_parcial_filtrado.php?proyecto_id=1\n";
?> 