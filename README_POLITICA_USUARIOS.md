...
#### Eliminación de Carpetas (Eliminación en Cascada)
- Solo `super_admin` y `admin` pueden eliminar carpetas
- Cuando se elimina una carpeta, se ejecuta una **eliminación en cascada** que elimina automáticamente:
  - ✅ Todos los archivos dentro de la carpeta (físicamente del servidor y en BD)
  - ✅ Todas las subcarpetas y su contenido completo (recursivamente)
  - ✅ Los archivos físicos del servidor son eliminados permanentemente
- La eliminación se registra en la tabla de actividades con el conteo de archivos y subcarpetas eliminadas
