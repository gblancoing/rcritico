  ...
  const ReportePredictividad = ({ 
    ...
    const cargarDatosGraficoFinanciero = async () => {
      ...
      try {
        ...
        console.log('📊 Datos cargados:', datosFinancieros.map(d => `${d.mes}: P=${d.proyeccion.toFixed(1)}M, R=${d.real.toFixed(1)}M`));
                ...
                {cargandoGraficoFinanciero ? (
                  ...
                  <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                      ...
                      />
                      <Tooltip 
                        formatter={(value, name) => [`${value.toFixed(1)}M USD`, name === 'proyeccion' ? 'Proyección' : 'Real']}
                      ...
                      {/* SVG para las líneas del gráfico */}
                      <svg style={{
                        position: 'absolute',
                        top: '0',
                        left: '0',
