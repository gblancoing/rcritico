    ...
    <div className="main-bg">
      ...
      <div className="ajuste-layout">
        ...
        <main className={`ajuste-content ${sidebarCollapsed ? 'sidebar-collapsed' : ''} ${sidebarHidden ? 'sidebar-hidden' : ''}`}>
          ...
          {/* Privilegios ACL View */}
          {currentView === 'privilegios' && (
            <div className="ajuste-container">
              <h1 className="ajuste-titulo">
                <i className="fa fa-key" style={{ marginRight: '0.75rem', color: '#F2A900' }}></i>
                MATRIZ DE PRIVILEGIOS (ACL)
              </h1>
              ...
              <div style={{ 
                ...
                <p style={{ margin: 0, fontSize: '0.95rem' }}>
                  ...
                  Esta tabla muestra los permisos y acciones permitidas para cada tipo de usuario en el sistema.
                </p>
              </div>
              ...
              <div style={{ 
                ...
                <div style={{ 
                  ...
                  <h2 style={{ margin: 0, fontSize: '1.1rem', fontWeight: 600 }}>
                    <i className="fa fa-users" style={{ marginRight: '0.5rem', color: '#F2A900' }}></i>
                    Roles del Sistema
                  </h2>
                </div>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1rem' }}>
                    ...
                    <div style={{ 
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '0.75rem' }}>
                        ...
                        <div>
                          ...
                          <span style={{ fontSize: '0.75rem', opacity: 0.8 }}>Acceso total al sistema</span>
                        </div>
                      </div>
                      <p style={{ fontSize: '0.85rem', margin: 0, opacity: 0.9 }}>
                        Control completo sobre todas las funcionalidades, usuarios y configuraciones del sistema.
                      </p>
                    </div>
                    ...
                    <div style={{ 
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '0.75rem' }}>
                        ...
                        <div>
                          <h3 style={{ margin: 0, fontSize: '1rem' }}>Administrador</h3>
                          <span style={{ fontSize: '0.75rem', opacity: 0.8 }}>Gestión de proyectos asignados</span>
                        </div>
                      </div>
                      <p style={{ fontSize: '0.85rem', margin: 0, opacity: 0.9 }}>
                        Puede gestionar usuarios, validar línea base y administrar carpetas dentro de su alcance.
                      </p>
                    </div>
                    ...
                    <div style={{ 
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '0.75rem' }}>
                        ...
                        <div>
                          <h3 style={{ margin: 0, fontSize: '1rem' }}>Trabajador</h3>
                          <span style={{ fontSize: '0.75rem', opacity: 0.8 }}>Usuario operativo</span>
                        </div>
                      </div>
                      <p style={{ fontSize: '0.85rem', margin: 0, opacity: 0.9 }}>
                        Puede reportar avances, comentar en el foro y subir respaldos de evidencias.
                      </p>
                    </div>
                    ...
                    <div style={{ 
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '0.75rem' }}>
                        ...
                        <div>
                          <h3 style={{ margin: 0, fontSize: '1rem' }}>Visita</h3>
                          <span style={{ fontSize: '0.75rem', opacity: 0.8 }}>Solo lectura</span>
                        </div>
                      </div>
                      <p style={{ fontSize: '0.85rem', margin: 0, opacity: 0.9 }}>
                        Puede visualizar información sin realizar modificaciones.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div style={{ 
                ...
                <div style={{ 
                  ...
                  <h2 style={{ margin: 0, fontSize: '1.1rem', fontWeight: 600 }}>
                    <i className="fa fa-table" style={{ marginRight: '0.5rem', color: '#F2A900' }}></i>
                    Matriz de Permisos - Módulos del Sistema
                  </h2>
                </div>
                  ...
                  <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.85rem' }}>
                    <thead>
                      <tr style={{ background: '#f8f9fa' }}>
                        <th style={{ padding: '1rem', textAlign: 'left', borderBottom: '2px solid #dee2e6', fontWeight: 600, minWidth: '200px' }}>
                          Funcionalidad / Módulo
                        </th>
                        <th style={{ padding: '1rem', textAlign: 'center', borderBottom: '2px solid #dee2e6', background: '#6f42c1', color: '#fff', minWidth: '100px' }}>
                          ⭐ Super Admin
                        </th>
                        <th style={{ padding: '1rem', textAlign: 'center', borderBottom: '2px solid #dee2e6', background: '#17a2b8', color: '#fff', minWidth: '100px' }}>
                          👔 Admin
                        </th>
                        <th style={{ padding: '1rem', textAlign: 'center', borderBottom: '2px solid #dee2e6', background: '#28a745', color: '#fff', minWidth: '100px' }}>
                          👷 Trabajador
                        </th>
                        <th style={{ padding: '1rem', textAlign: 'center', borderBottom: '2px solid #dee2e6', background: '#6c757d', color: '#fff', minWidth: '100px' }}>
                          👁️ Visita
                        </th>
                      </tr>
                    </thead>
                    <tbody>
                      ...
                      <tr style={{ background: '#e9ecef' }}>
                        <td colSpan="5" style={{ padding: '0.75rem 1rem', fontWeight: 700, color: '#495057' }}>
                          <i className="fa fa-cog" style={{ marginRight: '0.5rem' }}></i>
                          AJUSTES DEL SISTEMA
                        </td>
                      </tr>
                      <tr>
                        <td style={{ padding: '0.75rem 1rem', borderBottom: '1px solid #dee2e6' }}>Acceso a Panel de Ajustes</td>
                      ...
                      <tr>
                        <td style={{ padding: '0.75rem 1rem', borderBottom: '1px solid #dee2e6' }}>Gestionar Proyectos</td>
                        <td style={{ padding: '0.75rem', textAlign: 'center', borderBottom: '1px solid #dee2e6' }}><span style={{ color: '#28a745', fontSize: '1.2rem' }}>✓</span></td>
                        <td style={{ padding: '0.75rem', textAlign: 'center', borderBottom: '1px solid #dee2e6' }}><span style={{ color: '#ffc107', fontSize: '1rem' }}>👁️</span></td>
                        <td style={{ padding: '0.75rem', textAlign: 'center', borderBottom: '1px solid #dee2e6' }}><span style={{ color: '#dc3545', fontSize: '1.2rem' }}>✗</span></td>
                        <td style={{ padding: '0.75rem', textAlign: 'center', borderBottom: '1px solid #dee2e6' }}><span style={{ color: '#dc3545', fontSize: '1.2rem' }}>✗</span></td>
                      </tr>
                      <tr>
                        <td style={{ padding: '0.75rem 1rem', borderBottom: '1px solid #dee2e6' }}>Gestionar Centros de Costo</td>
                        <td style={{ padding: '0.75rem', textAlign: 'center', borderBottom: '1px solid #dee2e6' }}><span style={{ color: '#28a745', fontSize: '1.2rem' }}>✓</span></td>
                        <td style={{ padding: '0.75rem', textAlign: 'center', borderBottom: '1px solid #dee2e6' }}><span style={{ color: '#ffc107', fontSize: '1rem' }}>👁️</span></td>
                        <td style={{ padding: '0.75rem', textAlign: 'center', borderBottom: '1px solid #dee2e6' }}><span style={{ color: '#dc3545', fontSize: '1.2rem' }}>✗</span></td>
                        <td style={{ padding: '0.75rem', textAlign: 'center', borderBottom: '1px solid #dee2e6' }}><span style={{ color: '#dc3545', fontSize: '1.2rem' }}>✗</span></td>
                      ...
                      <tr>
                        <td style={{ padding: '0.75rem 1rem', borderBottom: '1px solid #dee2e6' }}>Gestionar Empresas Contratistas</td>
                        <td style={{ padding: '0.75rem', textAlign: 'center', borderBottom: '1px solid #dee2e6' }}><span style={{ color: '#28a745', fontSize: '1.2rem' }}>✓</span></td>
                        <td style={{ padding: '0.75rem', textAlign: 'center', borderBottom: '1px solid #dee2e6' }}><span style={{ color: '#ffc107', fontSize: '1rem' }}>👁️</span></td>
                        <td style={{ padding: '0.75rem', textAlign: 'center', borderBottom: '1px solid #dee2e6' }}><span style={{ color: '#dc3545', fontSize: '1.2rem' }}>✗</span></td>
                        <td style={{ padding: '0.75rem', textAlign: 'center', borderBottom: '1px solid #dee2e6' }}><span style={{ color: '#dc3545', fontSize: '1.2rem' }}>✗</span></td>
                      ...
                      <tr>
                        <td style={{ padding: '0.75rem 1rem', borderBottom: '1px solid #dee2e6' }}>Ver/Descargar Archivos</td>
                        <td style={{ padding: '0.75rem', textAlign: 'center', borderBottom: '1px solid #dee2e6' }}><span style={{ color: '#28a745', fontSize: '1.2rem' }}>✓</span></td>
                        <td style={{ padding: '0.75rem', textAlign: 'center', borderBottom: '1px solid #dee2e6' }}><span style={{ color: '#28a745', fontSize: '1.2rem' }}>✓</span></td>
                        <td style={{ padding: '0.75rem', textAlign: 'center', borderBottom: '1px solid #dee2e6' }}><span style={{ color: '#28a745', fontSize: '1.2rem' }}>✓</span></td>
                        <td style={{ padding: '0.75rem', textAlign: 'center', borderBottom: '1px solid #dee2e6' }}><span style={{ color: '#28a745', fontSize: '1.2rem' }}>✓</span></td>
                      ...
                      {/* Sección: Línea Base Nivel 1 */}
                      <tr style={{ background: '#e9ecef' }}>
                        <td colSpan="5" style={{ padding: '0.75rem 1rem', fontWeight: 700, color: '#495057' }}>
                          <i className="fa fa-list-alt" style={{ marginRight: '0.5rem' }}></i>
                          LÍNEA BASE - NIVEL 1 (Proyecto Principal)
                        </td>
                      </tr>
                      <tr>
                      ...
                      {/* Sección: Línea Base Nivel 2 */}
                      <tr style={{ background: '#e9ecef' }}>
                        <td colSpan="5" style={{ padding: '0.75rem 1rem', fontWeight: 700, color: '#495057' }}>
                          <i className="fa fa-list-alt" style={{ marginRight: '0.5rem' }}></i>
                          LÍNEA BASE - NIVEL 2 (Subcarpetas)
                        </td>
                      </tr>
                      <tr>
                        <td style={{ padding: '0.75rem 1rem', borderBottom: '1px solid #dee2e6' }}>Editar todos los campos</td>
                      ...
                      <tr>
                        <td style={{ padding: '0.75rem 1rem', borderBottom: '1px solid #dee2e6' }}>Editar solo "% Avance Implementación"</td>
                        <td style={{ padding: '0.75rem', textAlign: 'center', borderBottom: '1px solid #dee2e6' }}><span style={{ color: '#28a745', fontSize: '1.2rem' }}>✓</span></td>
                        <td style={{ padding: '0.75rem', textAlign: 'center', borderBottom: '1px solid #dee2e6' }}><span style={{ color: '#28a745', fontSize: '1.2rem' }}>✓</span></td>
                        <td style={{ padding: '0.75rem', textAlign: 'center', borderBottom: '1px solid #dee2e6' }}><span style={{ color: '#28a745', fontSize: '1.2rem' }}>✓</span></td>
                        <td style={{ padding: '0.75rem', textAlign: 'center', borderBottom: '1px solid #dee2e6' }}><span style={{ color: '#dc3545', fontSize: '1.2rem' }}>✗</span></td>
                      ...
                      <tr>
                        <td style={{ padding: '0.75rem 1rem', borderBottom: '1px solid #dee2e6' }}>Agregar mensajes y archivos</td>
                        <td style={{ padding: '0.75rem', textAlign: 'center', borderBottom: '1px solid #dee2e6' }}><span style={{ color: '#28a745', fontSize: '1.2rem' }}>✓</span></td>
                        <td style={{ padding: '0.75rem', textAlign: 'center', borderBottom: '1px solid #dee2e6' }}><span style={{ color: '#28a745', fontSize: '1.2rem' }}>✓</span></td>
                        <td style={{ padding: '0.75rem', textAlign: 'center', borderBottom: '1px solid #dee2e6' }}><span style={{ color: '#28a745', fontSize: '1.2rem' }}>✓</span></td>
                        <td style={{ padding: '0.75rem', textAlign: 'center', borderBottom: '1px solid #dee2e6' }}><span style={{ color: '#dc3545', fontSize: '1.2rem' }}>✗</span></td>
                      ...
                      <tr>
                        <td style={{ padding: '0.75rem 1rem', borderBottom: '1px solid #dee2e6' }}>Eliminar mensajes propios</td>
                        <td style={{ padding: '0.75rem', textAlign: 'center', borderBottom: '1px solid #dee2e6' }}><span style={{ color: '#28a745', fontSize: '1.2rem' }}>✓</span></td>
                        <td style={{ padding: '0.75rem', textAlign: 'center', borderBottom: '1px solid #dee2e6' }}><span style={{ color: '#28a745', fontSize: '1.2rem' }}>✓</span></td>
                        <td style={{ padding: '0.75rem', textAlign: 'center', borderBottom: '1px solid #dee2e6' }}><span style={{ color: '#28a745', fontSize: '1.2rem' }}>✓</span></td>
                        <td style={{ padding: '0.75rem', textAlign: 'center', borderBottom: '1px solid #dee2e6' }}><span style={{ color: '#dc3545', fontSize: '1.2rem' }}>✗</span></td>
                      ...
                      <tr>
                        <td style={{ padding: '0.75rem 1rem', borderBottom: '1px solid #dee2e6' }}>Eliminar mensajes de Trabajadores</td>
                        <td style={{ padding: '0.75rem', textAlign: 'center', borderBottom: '1px solid #dee2e6' }}><span style={{ color: '#28a745', fontSize: '1.2rem' }}>✓</span></td>
                        <td style={{ padding: '0.75rem', textAlign: 'center', borderBottom: '1px solid #dee2e6' }}><span style={{ color: '#28a745', fontSize: '1.2rem' }}>✓</span></td>
                        <td style={{ padding: '0.75rem', textAlign: 'center', borderBottom: '1px solid #dee2e6' }}><span style={{ color: '#dc3545', fontSize: '1.2rem' }}>✗</span></td>
                        <td style={{ padding: '0.75rem', textAlign: 'center', borderBottom: '1px solid #dee2e6' }}><span style={{ color: '#dc3545', fontSize: '1.2rem' }}>✗</span></td>
                      ...
                      <tr>
                        <td style={{ padding: '0.75rem 1rem', borderBottom: '1px solid #dee2e6' }}>Eliminar mensajes de Admins</td>
                        <td style={{ padding: '0.75rem', textAlign: 'center', borderBottom: '1px solid #dee2e6' }}><span style={{ color: '#28a745', fontSize: '1.2rem' }}>✓</span></td>
                        <td style={{ padding: '0.75rem', textAlign: 'center', borderBottom: '1px solid #dee2e6' }}><span style={{ color: '#dc3545', fontSize: '1.2rem' }}>✗</span></td>
                        <td style={{ padding: '0.75rem', textAlign: 'center', borderBottom: '1px solid #dee2e6' }}><span style={{ color: '#dc3545', fontSize: '1.2rem' }}>✗</span></td>
                        <td style={{ padding: '0.75rem', textAlign: 'center', borderBottom: '1px solid #dee2e6' }}><span style={{ color: '#dc3545', fontSize: '1.2rem' }}>✗</span></td>
                      ...
                      <tr>
                        <td style={{ padding: '0.75rem 1rem', borderBottom: '1px solid #dee2e6' }}>Eliminar mensajes de Super Admins</td>
                        <td style={{ padding: '0.75rem', textAlign: 'center', borderBottom: '1px solid #dee2e6' }}><span style={{ color: '#dc3545', fontSize: '1.2rem' }}>✗</span></td>
                        <td style={{ padding: '0.75rem', textAlign: 'center', borderBottom: '1px solid #dee2e6' }}><span style={{ color: '#dc3545', fontSize: '1.2rem' }}>✗</span></td>
                        <td style={{ padding: '0.75rem', textAlign: 'center', borderBottom: '1px solid #dee2e6' }}><span style={{ color: '#dc3545', fontSize: '1.2rem' }}>✗</span></td>
                        <td style={{ padding: '0.75rem', textAlign: 'center', borderBottom: '1px solid #dee2e6' }}><span style={{ color: '#dc3545', fontSize: '1.2rem' }}>✗</span></td>
                      ...
                      {/* Sección: Análisis Bowtie */}
                      <tr style={{ background: '#e9ecef' }}>
                        <td colSpan="5" style={{ padding: '0.75rem 1rem', fontWeight: 700, color: '#495057' }}>
                          <i className="fa fa-share-alt" style={{ marginRight: '0.5rem' }}></i>
                          ANÁLISIS BOWTIE
                        </td>
                      </tr>
                      <tr>
                        <td style={{ padding: '0.75rem 1rem', borderBottom: '1px solid #dee2e6' }}>Crear/Editar Análisis Bowtie</td>
                        <td style={{ padding: '0.75rem', textAlign: 'center', borderBottom: '1px solid #dee2e6' }}><span style={{ color: '#28a745', fontSize: '1.2rem' }}>✓</span></td>
                        <td style={{ padding: '0.75rem', textAlign: 'center', borderBottom: '1px solid #dee2e6' }}><span style={{ color: '#28a745', fontSize: '1.2rem' }}>✓</span></td>
                        <td style={{ padding: '0.75rem', textAlign: 'center', borderBottom: '1px solid #dee2e6' }}><span style={{ color: '#dc3545', fontSize: '1.2rem' }}>✗</span></td>
                        <td style={{ padding: '0.75rem', textAlign: 'center', borderBottom: '1px solid #dee2e6' }}><span style={{ color: '#dc3545', fontSize: '1.2rem' }}>✗</span></td>
                      ...
                      <tr>
                        <td style={{ padding: '0.75rem 1rem', borderBottom: '1px solid #dee2e6' }}>Visualizar Análisis Bowtie</td>
                        <td style={{ padding: '0.75rem', textAlign: 'center', borderBottom: '1px solid #dee2e6' }}><span style={{ color: '#28a745', fontSize: '1.2rem' }}>✓</span></td>
                        <td style={{ padding: '0.75rem', textAlign: 'center', borderBottom: '1px solid #dee2e6' }}><span style={{ color: '#28a745', fontSize: '1.2rem' }}>✓</span></td>
                        <td style={{ padding: '0.75rem', textAlign: 'center', borderBottom: '1px solid #dee2e6' }}><span style={{ color: '#28a745', fontSize: '1.2rem' }}>✓</span></td>
                        <td style={{ padding: '0.75rem', textAlign: 'center', borderBottom: '1px solid #dee2e6' }}><span style={{ color: '#28a745', fontSize: '1.2rem' }}>✓</span></td>
              ...
              <div style={{ 
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                  ...
                  <span style={{ fontSize: '0.9rem', color: '#495057' }}>Permitido</span>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                  <span style={{ color: '#dc3545', fontSize: '1.5rem' }}>✗</span>
                  <span style={{ fontSize: '0.9rem', color: '#495057' }}>No permitido</span>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                  <span style={{ color: '#ffc107', fontSize: '1.2rem' }}>👁️</span>
                  <span style={{ fontSize: '0.9rem', color: '#495057' }}>Solo lectura</span>
                </div>
              </div>
            </div>
          )}
      ...
      {showFormUsuario && (
        <div className="usuarios-modal-bg">
          <div className="usuarios-modal usuarios-modal-compact">
            <div className="usuarios-modal-header-compact">
              <div className="modal-icon-circle">
                <i className={editingItem ? "fa fa-user-edit" : "fa fa-user-plus"}></i>
              </div>
              <h3>{editingItem ? 'Editar Usuario' : 'Nuevo Usuario'}</h3>
              <button 
                type="button" 
                className="modal-close-btn"
                onClick={() => { setShowFormUsuario(false); setEditingItem(null); }}
              >
                <i className="fa fa-times"></i>
              </button>
            </div>
            <form className="usuarios-modal-form-compact" onSubmit={handleSubmitUsuario}>
              {/* Fila 1: Nombre y Email */}
              <div className="form-row-2col">
                <label className="form-field-compact">
                  <span><i className="fa fa-user"></i> Nombre</span>
                  <input
                    type="text"
              ...
              <div className="form-row-2col">
                <label className="form-field-compact">
                  <span><i className="fa fa-lock"></i> Contraseña</span>
                  <input
                    type="password"
                  ...
                  />
                  {editingItem && <small className="field-hint">Dejar vacío para mantener</small>}
                </label>
                <label className="form-field-compact">
                  <span><i className="fa fa-id-badge"></i> Rol</span>
                  <select
              ...
              {/* Fila 3: Región y Proyecto */}
              <div className="form-row-2col">
                <label className="form-field-compact">
                  <span><i className="fa fa-map-marker-alt"></i> Región</span>
                  <select
                ...
                <label className="form-field-compact">
                  <span><i className="fa fa-project-diagram"></i> Proyecto</span>
                  <select
              ...
              {/* Fila 4: Centro de costo y Empresa */}
              <div className="form-row-2col">
                <label className="form-field-compact">
                  <span><i className="fa fa-building"></i> Centro de Costo</span>
                  <select
                ...
                <label className="form-field-compact">
                  <span><i className="fa fa-industry"></i> Empresa Contratista</span>
                  <select
              ...
              {/* Fila 5: Aprobado (centrado) */}
              <div className="form-row-single-center">
                <label className="form-field-compact form-field-toggle">
                  <span><i className="fa fa-check-circle"></i> Estado</span>
                  <div className="toggle-switch-container">
                    <button 
                      type="button"
                      className={`toggle-btn ${formUsuario.aprobado === 1 ? 'active' : ''}`}
                      onClick={() => setFormUsuario(f => ({...f, aprobado: 1}))}
                    >
                      <i className="fa fa-check"></i> Aprobado
                    </button>
                    <button 
                      type="button"
                      className={`toggle-btn ${formUsuario.aprobado === 0 ? 'active inactive' : ''}`}
                      onClick={() => setFormUsuario(f => ({...f, aprobado: 0}))}
                    >
              ...
              <div className="modal-actions-compact">
                <button type="button" className="btn-cancel-compact" onClick={() => { setShowFormUsuario(false); setEditingItem(null); }}>
                  Cancelar
                </button>
                <button type="submit" className="btn-submit-compact">
                  <i className={editingItem ? "fa fa-save" : "fa fa-plus"}></i>
